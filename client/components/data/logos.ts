...
export const SECOND_CAROUSEL_LOGOS: LogoItem[] = [
  ...
  { src: "/images/logos/SHIAFFER.png", alt: "Shiaffer", heightClass: "h-14" },
  {
    src: "/images/logos/KPI-CONSULTING.png",
    alt: "KPI Consulting",
    heightClass: "h-20",
  },
  { src: "/images/logos/LA-POSTAL.png", alt: "La Postal", heightClass: "h-14" },
  {
    src: "/images/logos/LOGISTICA-GARPIC.png",
    alt: "Logística Garpic",
    heightClass: "h-20",
  },
  { src: "/images/logos/LOGO-CARGO.png", alt: "Cargo", heightClass: "h-14" },
