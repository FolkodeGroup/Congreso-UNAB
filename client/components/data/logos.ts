...
export const DEFAULT_LOGOS: LogoItem[] = [
  ...
  { src: "/images/logos/ARLOG.jpg", alt: "ARLOG", heightClass: "h-14" },
  { src: "/images/logos/CHAGA.jpeg", alt: "CHAGA", heightClass: "h-16" },
  { src: "/images/logos/CITYONE.jpeg", alt: "CityOne", heightClass: "h-14" },
  ...
  { src: "/images/logos/ESUCELA-CHOFERES.png", alt: "Escuela de Choferes", heightClass: "h-12" },
  { src: "/images/logos/ETRACK.png", alt: "eTrack", heightClass: "h-14" },
...
export const FIRST_CAROUSEL_LOGOS: LogoItem[] = [
  ...
  { src: "/images/logos/CITYONE.jpeg", alt: "CityOne", heightClass: "h-14" },
  { src: "/images/logos/CONWORK.jpg", alt: "Conwork", heightClass: "h-14" },
  { src: "/images/logos/ELECE-LOGISTICA.png", alt: "Logística E-LECE", heightClass: "h-12" },
];
...
export const SECOND_CAROUSEL_LOGOS: LogoItem[] = [
  ...
  { src: "/images/logos/LOGISTICA-CARPIC.jpg", alt: "Logística Carpic", heightClass: "h-16" },
...
export const THIRD_CAROUSEL_LOGOS: LogoItem[] = [
  ...
  { src: "/images/logos/TRANSPORTE-DOMINGUEZ.jpeg", alt: "Transporte Dominguez", heightClass: "h-14" },
